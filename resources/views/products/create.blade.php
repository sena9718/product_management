...
<div class="container">
    ...
    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input id="product_name" type="text" name="product_name" value="{{ old('product_name') }}" class="form-control">
        ...
        <div class="mb-3">
            ...
            <input id="stock" type="text" name="stock" value="{{ old('stock') }}" class="form-control">
            @if($errors->has('stock'))
        ...
        <div class="mb-3">
            ...
            <input id="img_path" type="file" name="img_path" value="{{ old('img_path') }}" class="form-control">
